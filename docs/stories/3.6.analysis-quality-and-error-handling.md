...
- Added strict response validators with structured error codes and fallback heuristics for both analysis steps.
- Implemented retry sequencing across provider aliases and preserved partial outputs with quality/confidence scoring.
- Captured prompt/response debugging metadata to aid diagnostics and manual review workflows.
