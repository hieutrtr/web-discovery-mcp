...
| 2025-09-17 | 0.2 | Implemented diagnostics tools and tests | James (Dev) |
...
- Added diagnostics module with health check, dependency validation, and LLM key checks.
- Implemented system status snapshot leveraging asyncio metrics and resource usage.
- Created unit tests covering diagnostics behaviours and configuration validation.

### File List

- src/legacy_web_mcp/diagnostics/__init__.py
- src/legacy_web_mcp/diagnostics/health.py
- tests/unit/diagnostics/test_health.py
