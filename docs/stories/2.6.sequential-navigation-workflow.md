...
| 2025-09-18 | 0.2 | Implemented sequential workflow orchestration | James (Dev) |
...
- Added sequential navigation workflow orchestrator with queue, skip, and checkpoint support.
- Integrated navigation, analysis, and network capture modules inside workflow run loop.
        - Covered workflow pause/skip behaviour with unit tests and checkpoint persistence.
